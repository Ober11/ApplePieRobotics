...
def big_lap():
    ...
    #   3d mozi
    g.reset()
    kr.on_for_degrees(-100, 300, False)
    forandbackward(50, 700, -15)
    kr.on_for_degrees(30, 500)
    time.sleep(0.4)
    turn(-35, timeout=4)
    time.sleep(0.4)
    kr.on_for_degrees(30, 150)
    time.sleep(0.3)
    kr.on_for_degrees(-30, 750)
    turn(-15)
    forandbackward(70, -900, -2)
    turn(-51)
    forandbackward(70, -320, -51)
    g.reset()
    
    #   jelenetváltás
    time.sleep(0.2)
    forandbackward(60, 800, 0)
    kl.on_for_degrees(30, 120)
    time.sleep(0.2)
    forandbackward(50, 425)
    turn(60)
